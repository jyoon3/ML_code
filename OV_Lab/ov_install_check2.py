...
try:
    ...
    # ov.__version__ 대신 openvino.runtime.__version__을 사용
    # 참고: 2024.0 이후 버전부터 openvino.__version__ 사용이 더 일반적입니다.
    # 하지만 요청에 따라 openvino.runtime을 명시적으로 사용합니다.
    print(f"OpenVINO 버전: {ov_runtime.__version__}") 
